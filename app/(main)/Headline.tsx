...
function Developer() {
  return (
    <span className="group">
      <span className="font-mono">&lt;</span>专利从业
...
export function Headline() {
  return (
    <div className="max-w-2xl">
      ...
      >
        <SocialLink
          href="https://cali1.so/twitter"
          aria-label="我的推特"
          platform="twitter"
        />
        <SocialLink
          href="https://cali1.so/youtube"
          aria-label="我的 YouTube"
          platform="youtube"
        />
        <SocialLink
          href="https://cali1.so/bilibili"
          aria-label="我的 Bilibili"
          platform="bilibili"
        />
        <SocialLink
          href="https://cali1.so/github"
          aria-label="我的 GitHub"
          platform="github"
        />
        <SocialLink
          href="https://cali1.so/tg"
          aria-label="我的 Telegram"
          platform="telegram"
        />
        <SocialLink href="/feed.xml" platform="rss" aria-label="RSS 订阅" />
        <SocialLink
          href="mailto:hi@cali1.so"
          aria-label="我的邮箱"
          platform="mail"
        />
      </motion.div>
